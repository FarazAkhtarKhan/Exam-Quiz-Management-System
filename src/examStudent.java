...
public class examStudent extends javax.swing.JFrame {
    ...
    try{
               ...
               ResultSet rs1 = s.executeQuery("Select * from question where id='"+questionId+"'");
               while(rs1.next())
               {
    ...
    public void submit()
    {
        ...
        try{
            Connection con = ConnectionProvider.getCon();
            Statement s = con.createStatement();
            s.executeUpdate("update student set marks='"+marks+"' where rollNo='"+rollNo+"' ");
            String marks1 = String.valueOf(marks);
            setVisible(false);
    ...
    private void initComponents() {
        ...
        getContentPane().add(jPanel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1710, -1));
        ...
        jLabel14.setText("Total Quesions:");
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 110, -1, 1040));

        jLabel20.setFont(new java.awt.Font("Segoe UI", 1, 30)); // NOI18N
        jLabel20.setText("Demo Question?");
        getContentPane().add(jLabel20, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 140, 932, -1));
        ...
        getContentPane().add(jRadioButton1, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 280, 932, -1));
        ...
        getContentPane().add(jRadioButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 360, 932, -1));

        jRadioButton3.setFont(new java.awt.Font("Segoe UI", 1, 30)); // NOI18N
        ...
        getContentPane().add(jRadioButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 440, 932, -1));

        jRadioButton4.setFont(new java.awt.Font("Segoe UI", 1, 30)); // NOI18N
        ...
        getContentPane().add(jRadioButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 520, 932, -1));
        ...
        getContentPane().add(jButton2, new org.netbeans.lib.awtextra.AbsoluteConstraints(1370, 610, -1, -1));

        jLabel21.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Student Backgroung big.jpg"))); // NOI18N
        jLabel21.setText("jLabel21");
        getContentPane().add(jLabel21, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 10, 1710, 1200));
